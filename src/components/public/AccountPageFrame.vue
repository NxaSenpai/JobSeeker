...
<template>
  <section class="account-page">
    <h1>{{ title }}</h1>
    <p class="account-description mb-5">{{ description }}</p>
...
.account-field :is(input, textarea, select) {
  min-width: 0;
  max-width: 100%;
...
.account-tabs a.router-link-exact-active {
  color: #6b58d4;
  border-color: #7b66ff;
}
.account-panel {
...
.account-page :is(button, a, input, textarea):focus-visible {
  outline: 2px solid #7b66ff;
  outline-offset: 3px;
}
.account-form {
